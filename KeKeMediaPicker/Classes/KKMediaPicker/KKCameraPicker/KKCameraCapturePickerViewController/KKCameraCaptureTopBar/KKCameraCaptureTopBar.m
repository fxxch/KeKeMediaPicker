...
- (void)initUI{
    ...
    CGFloat space = (((UIWindow*)[UIWindow kkmp_currentKeyWindow]).bounds.size.width-10-60*4)/3.0;
...
- (UIImage*)themeImageForName:(NSString*)aImageName{
    UIImage *image = [NSBundle kkmp_imageInBundle:@"KKCameraCapture.bundle" imageName:aImageName];
    return image;
}
