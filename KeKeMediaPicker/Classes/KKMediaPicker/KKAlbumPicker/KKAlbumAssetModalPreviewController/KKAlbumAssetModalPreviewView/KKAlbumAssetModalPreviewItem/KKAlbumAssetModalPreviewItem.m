...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        [NSNotificationCenter.defaultCenter addObserver:self selector:@selector(Notification_KKAlbumAssetModalPreviewItemResetZoomScale:) name:@"NotificationName_KKAlbumAssetModalPreviewItemResetZoomScale" object:nil];
